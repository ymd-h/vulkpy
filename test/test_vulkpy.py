...
class TestBuffer(unittest.TestCase):
    ...
    def test_add(self):
        a = vk.Buffer(self.gpu, data=[5, 5, 5])
        b = vk.Buffer(self.gpu, data=[1, 1, 1])
        c = a + b
        c.wait()
    ...
    def test_sub(self):
        a = vk.Buffer(self.gpu, data=[4, 4, 4])
        b = vk.Buffer(self.gpu, data=[2, 2, 2])
        c = a - b
        c.wait()
    ...
    def test_mul(self):
        a = vk.Buffer(self.gpu, data=[2, 2, 2])
        b = vk.Buffer(self.gpu, data=[3, 3, 3])
        c = a * b
        c.wait()
    ...
    def test_div(self):
        a = vk.Buffer(self.gpu, data=[8, 8, 8])
        b = vk.Buffer(self.gpu, data=[2, 2, 2])
        c = a / b
        c.wait()
    ...
    def test_iadd(self):
        a = vk.Buffer(self.gpu, data=[2, 2, 2])
        b = vk.Buffer(self.gpu, data=[5, 5, 5])
        a += b
        a.wait()
    ...
    def test_isub(self):
        a = vk.Buffer(self.gpu, data=[7, 7, 7])
        b = vk.Buffer(self.gpu, data=[3, 3, 3])
        a -= b
        a.wait()
    ...
    def test_imul(self):
        a = vk.Buffer(self.gpu, data=[3, 3, 3])
        b = vk.Buffer(self.gpu, data=[2, 2, 2])
        a *= b
        a.wait()
    ...
    def test_rsub_scalar(self):
        a = vk.Buffer(self.gpu, data=[6, 6, 6])
        b = 4 - a
        b.wait()
